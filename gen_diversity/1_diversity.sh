...
# synonymous and non-synonymous pi
perl ../software/popoolation_1.2.2/syn-nonsyn/Syn-nonsyn-at-position.pl --measure pi --gtf ../ref/cds_popoolation.gtf --pileup N1.idf.tef.pileup --codon-table ../software/popoolation_1.2.2/syn-nonsyn/codon-table.txt --nonsyn-length-table ../software/popoolation_1.2.2/syn-nonsyn/nsl_p1.txt  --output tef_out/N1.syn.tef.pi --pool-size 104 --snp-output N1.synon.snps
perl ../software/popoolation_1.2.2/syn-nonsyn/Syn-nonsyn-at-position.pl --measure pi --gtf ../ref/cds_popoolation.gtf --pileup N2.idf.tef.pileup --codon-table ../software/popoolation_1.2.2/syn-nonsyn/codon-table.txt --nonsyn-length-table ../software/popoolation_1.2.2/syn-nonsyn/nsl_p1.txt  --output tef_out/N2.syn.tef.pi --pool-size 118 --snp-output N2.synon.snps
perl ../software/popoolation_1.2.2/syn-nonsyn/Syn-nonsyn-at-position.pl --measure pi --gtf ../ref/cds_popoolation.gtf --pileup F1.idf.tef.pileup --codon-table ../software/popoolation_1.2.2/syn-nonsyn/codon-table.txt --nonsyn-length-table ../software/popoolation_1.2.2/syn-nonsyn/nsl_p1.txt  --output tef_out/F1.syn.tef.pi --pool-size 82 --snp-output F1.synon.snps
perl ../software/popoolation_1.2.2/syn-nonsyn/Syn-nonsyn-at-position.pl --measure pi --gtf ../ref/cds_popoolation.gtf --pileup F2.idf.tef.pileup --codon-table ../software/popoolation_1.2.2/syn-nonsyn/codon-table.txt --nonsyn-length-table ../software/popoolation_1.2.2/syn-nonsyn/nsl_p1.txt  --output tef_out/F2.syn.tef.pi --pool-size 104 --snp-output F2.synon.snps
